...
public class Kobold1 extends NarrowRace {

	public static final NarrowRace instance = new Kobold1();
	...
	public List<EnemyType> getApplyTypes() {
		return Arrays.asList(EnemyType.ARMOROR, EnemyType.FENCER, EnemyType.SPEAR);
	}
