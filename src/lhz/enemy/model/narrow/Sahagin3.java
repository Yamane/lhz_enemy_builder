...
public class Sahagin3 extends NarrowRace {

	public static final NarrowRace instance = new Sahagin3();
	...
	public List<EnemySkill> getDefaultSkills(Enemy enemy) {
		...
		skill.createFunction("このエネミーは常に［弱点 (電撃):%d］を持つ。", enemy.getParameter(5, 1, 10));
